...
function DashboardView({
  ...
  const cardConfigs = [
    ...
    {
      label: "New",
      count: stats.New || stats.new || 0,
      icon: UserPlus,
      class: "new",
    },
    {
      label: "Contacted",
      count: stats.Contacted || stats.contacted || 0,
      icon: PhoneCall,
      class: "contacted",
    },
    {
      label: "Qualified",
      count: stats.Qualified || stats.qualified || 0,
      icon: Award,
      class: "qualified",
    },
    {
      label: "Converted",
      count: stats.Converted || stats.converted || 0,
      icon: CheckCircle2,
      class: "converted",
    },
    {
      label: "Lost",
      count: stats.Lost || stats.lost || 0,
      icon: XCircle,
      class: "lost",
    },
  ];
