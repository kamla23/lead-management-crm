...
function LeadsView({ list, query, setquery, filt, setfilt, page, setpage, pages, setcur, setopen, dellead, load }) {
  return (
    <>
      <header className="head">
        <h1>All Active Leads</h1>
        <button className="btn btn-with-icon" onClick={() => { setcur(null); setopen(true); }}>
